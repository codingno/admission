...
export default function FormAdmission() {
    ...
    console.log("🚀 ~ file: form.jsx ~ line 116 ~ FormAdmission ~ preFaculty", preFaculty)
		const [preMajor, setPreMajor] = useState("")
    console.log("🚀 ~ file: form.jsx ~ line 118 ~ FormAdmission ~ preMajor", preMajor)
		...
		useEffect(() => {
			...
			async function getDataSaved() {
				try {
					...
					if(data) {
						if(data.submitted)
							return router.push('/admission/' + data.id)
		...
		if (!preAdmission) {
			return (
					...
					>
						...
						>
							<Stack>
								<Typography variant="h5" color="primary" textAlign="center">Considering applying to UIII?</Typography>	
								<Typography variant="h5" color="primary" textAlign="center">Let us know your interest</Typography>	
								<FormParent>
									<Autocomplete
										disablePortal
										id="combo-box-demo"
								...
								<FormParent>
									<Autocomplete
										...
										sx={{ width: "100%" }}
										renderInput={(params) => <TextField {...params} label="Study Program" />}
										// getOptionLabel={x => x.faculty || ""}
									/>
									{/* <FormControl sx={{ 
									width: "100%" 
								...
								<FormParent>
									...
									width: "100%" 
										...
										<TextField label="Nationality" name="nationality" type="text" inputRef={preAdmissionNationalityRef} />
									</FormControl>
								</FormParent>
								<FormControl component="fieldset" sx={{ my : 1.5, ml : 1, }} variant="outlined">
									<FormLabel component="legend">Gender</FormLabel>
									<RadioGroup value={preAdmissionGender} onChange={(e, dt) => setPreAdmissionGender(dt) } name="gender" >
										<Stack
											direction="row"
								...
								<LoadingButton variant='contained' loading={preAdmissionLoading} 
								onClick={async () => {
									try {
										...
										if (faculty == "" || program_study == "" || nationality == "")
											return alert("Please fill in all the fields to continue the process.")
										...
										const { data } = await axios.post('/api/pre-admission',[preparePreAdmission])
															...
															return (
																<FormControl component="fieldset">
																	...
																	<RadioGroup  {...props} >
																		...
																		>
																		<FormControlLabel value="Self financing" control={<Radio />} label="Self financing" />
																		...
																		<Stack
																			// ml={3}
																		>
																			<FormControlLabel value="IIIU Admission for Master Program" control={<Radio />} label="IIIU Admission for Master Program" /> <FormControlLabel value="LPDP - IIIU Admission for Doctor Program" control={<Radio />} label="LPDP - IIIU Admission for Doctor Program" />
													...
													<FormControl component="fieldset">
														...
														>
															...
															>
															{
																...
																<FormControlLabel value={x.faculty} control={<Radio />} label={x.faculty} checked={faculty == x.faculty} />
																)
															}
															</Stack>
														</RadioGroup>
													...
													<br />
																<FormControl component="fieldset">
																	...
																	>
																		...
																		{
																			!faculty ? "" :
																			optionsFaculty.filter(x => x.faculty == faculty)[0]?.major.map(x => 
																			<FormControlLabel value={x} control={<Radio />} label={x} checked={x == major} />
																			)
																		}
																		</Stack>
																	</RadioGroup>
															...
															return (
																<FormControl component="fieldset">
																	<RadioGroup  {...props} >
																		...
																		<FormControlLabel value="Self Employment" control={<Radio />} label="Self Employment" />
																		<FormControlLabel value="Currently employed" control={<Radio />} label="Employed" />
																		</Stack>
																	</RadioGroup>
																	<FormHelperText></FormHelperText>
																</FormControl>
															...
															return (
																<FormControl component="fieldset">
																	...
																	<RadioGroup  {...props} >
																		...
																		>
																		<FormControlLabel value="Goverment/public" control={<Radio />} label="Goverment / public" />
																		<FormControlLabel value="Private" control={<Radio />} label="Private" />
																		<FormControlLabel value="Education" control={<Radio />} label="Education" />
																		<FormControlLabel value="NGO/civil society" control={<Radio />} label="NGO / civil society" />
										...
										<TabPanel value='referee-details' >
											...
											>
												...
												>
													...
													<Button variant="contained" type="submit" sx={{ width : '250px', margin : '1rem 0 1rem 0', }} disable={loading} onClick={() => {
													...
													<Grid
														...
														>
															<FormGroup>
																...
																<ul>
																	...
																	<li>
																		...
																		<Typography variant="body1" color="error">
																			UIII has the right to vary or cancel any incorrect or incomplete information, made on the basis provided by me or by my referees.
																		</Typography>
																	</li>
																	<li>
																		{/* <Typography variant="body1" color="initial">
																		...
																		<Typography variant="body1" color="initial">
																			Decisions of the admissions committee are final and confidential and no correspondence about outcomes of the admission process will be entered to
																		</Typography>
																	</li>
																	<li>
																		<Typography variant="body1" color="initial">
															...
															<FormGroup>
																...
																<Typography variant="body1" color="initial">If successful in being accepted by the UIII Admissions, I agree that I will:</Typography>
																<ul>
																	<li>
																		<Typography variant="body1" color="initial">
															...
															>
																...
																>
																	Save</Button> */}
																<Button variant="contained" sx={{ width : '250px', margin : '1rem 0 1rem 1rem', }} onClick={async () => {
																		if(confirm("Are you sure to submit data?"))
																			try {
																				// await handleSubmit(submitForm)
																				const watchAllFields = watch()
																				await axios.post('/api/admission/' + session.user.ID, watchAllFields)
																				await axios.patch('/api/admission/' + session.user.ID, { submitted : true})	
